...
Version  : 11
Release  : 25
URL      : http://localhost/cgit/projects/clr-update-triggers/snapshot/clr-update-triggers-11.tar.gz
Source0  : http://localhost/cgit/projects/clr-update-triggers/snapshot/clr-update-triggers-11.tar.gz
...
install -D -m 0755 10-xdg.sh %{buildroot}/usr/libexec/updater/10-xdg.sh
