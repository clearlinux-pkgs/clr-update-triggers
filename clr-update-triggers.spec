...
Version  : 12
Release  : 1
URL      : http://localhost/cgit/projects/clr-update-triggers/snapshot/clr-update-triggers-12.tar.gz
Source0  : http://localhost/cgit/projects/clr-update-triggers/snapshot/clr-update-triggers-12.tar.gz
